...
@endif
<li class="breadcrumb-item"><a href="#">{{__('Project Details')}}</a></li>
@endsection
@php
                        ...
                        <div class="row">
                         ...
                         <div class="card ">
                            <div class="card-body">
                                ...
                                <h3 class="mb-0">{{ __('Team Members') }} ({{count($project->users)}})</h3>
                        ...
                        <div class="col-6">
                         <div class="card" style="min-height:350;">
                            <div class="card-body">
                                ...
                                <h3 class="mb-0">{{ __('Clients') }} ({{count($project->clients)}})</h3>
                           ...
                           <div class="col-md-8">
                              @if((isset($permissions) && in_array('show milestone', $permissions)) || $currentWorkspace->permission == 'Owner')
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <h3 class="mb-0">{{__('Milestones')}} ({{count($project->milestones)}})</h3>
                                        ...
                                        @foreach($project->milestones as $key => $milestone)
                                            <div class="list-group-item">
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-auto">
                                                        @if($currentWorkspace->permission == 'Owner')
                                                            <a href="#" class="action-btn btn-info mx-1  btn btn-sm d-inline-flex align-items-center" data-ajax-popup="true" data-size="lg" data-title="{{__('Edit Milestone')}}" data-url="{{route('projects.milestone.edit',[$currentWorkspace->slug,$milestone->id])}}"  data-toggle="popover" title="{{__('Edit')}}"><i class="ti ti-edit"></i></a>
                                                            <a href="#" class="action-btn btn-danger mx-1  btn btn-sm d-inline-flex align-items-center bs-pass-para" data-confirm="{{__('Are You Sure?')}}" data-text="{{__('This action can not be undone. Do you want to continue?')}}" data-toggle="popover" title="{{__('Delete')}}" data-confirm-yes="delete-form1-{{$milestone->id}}"><i class="ti ti-trash"></i></a>
                                                        ...
                                                        @elseif(isset($permissions))
                                                            @if(in_array('edit milestone',$permissions))
                                                                <a href="#" class="action-btn btn-info mx-1  btn btn-sm d-inline-flex align-items-center bs-pass-para" data-toggle="popover" title="{{__('Edit')}}" data-ajax-popup="true" data-size="lg" data-title="{{__('Edit Milestone')}}" data-url="{{route($client_keyword.'projects.milestone.edit',[$currentWorkspace->slug,$milestone->id])}}" data-toggle="popover" title="{{__('Edit')}}"><i class="ti ti-edit"></i></a>
                                                            @endif
