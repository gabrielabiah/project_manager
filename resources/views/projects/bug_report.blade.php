...
<li class="breadcrumb-item"><a href="#">{{__('Bug Report')}}</a></li>
@endsection
                                ...
                                <div class="card" id="{{$bug->id}}">
                                   <!--  <img class="img-fluid card-img-top" src=""
                                    ...
                                    <div class="card-header border-0 pb-0 position-relative">
                                        ...
                                        <div style="padding: 30px 2px;"> <a href="#" data-url="{{route($client_keyword.'projects.bug.report.show',[$currentWorkspace->slug,$bug->project_id,$bug->id])}}" data-ajax-popup="true" data-title="{{__('Bug Detail')}}" class="h6 task-title"><h5>{{$bug->title}}</h5></a></div>
