...
<li class="breadcrumb-item"><a href="#">{{__('Task Board')}}</a></li>
@endsection
                                ...
                                <div class="card" id="{{$task->id}}">
                                   <!--  <img class="img-fluid card-img-top" src=""
                                    ...
                                    <div class="card-header border-0 pb-0 position-relative">
                                        ...
                                        <div style="padding: 30px 2px;"> <a href="#" data-url="{{route($client_keyword.'tasks.show',[$currentWorkspace->slug,$task->project_id,$task->id])}}" data-ajax-popup="true" data-title="{{__('Task Detail')}}" class="h6 task-title"><h5>{{$task->title}}</h5></a></div>
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        var html = "<div class='card mb-1 shadow-none border'>" +
                            ...
                            "                                </div>" +
                            "                                <div class='col-auto'>" +
                            "                                    <a download href='{{asset('/storage/tasks/')}}/" + data.file + "' class='edit-icon action-btn btn-primary  btn btn-sm d-inline-flex align-items-center mx-1'>" +
