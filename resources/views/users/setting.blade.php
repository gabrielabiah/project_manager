                    ...
                    <div class="col-xl-3">
                        <div class="card sticky-top" style="top:30px">
                            <div class="list-group list-group-flush" id="useradd-sidenav">
                                <a href="#site-settings" class="list-group-item list-group-item-action ">{{__('Site Setting')}} <div class="float-end"><i class="ti ti-chevron-right"></i></div></a> 
                                <a href="#task-stages-settings" class="list-group-item list-group-item-action dash-link ">{{__('Task Stages')}} <div class="float-end"><i class="ti ti-chevron-right"></i></div></a>
                                <a href="#bug-stages-settings" class="list-group-item list-group-item-action">{{__('Bug Stages')}}  <div class="float-end"><i class="ti ti-chevron-right"></i></div></a>
                                <a href="#taxes-settings" class="list-group-item list-group-item-action">{{__('Taxes')}} <div class="float-end"><i class="ti ti-chevron-right"></i></div></a>
                                <a href="#billing-settings" class="list-group-item list-group-item-action">{{__('Billing')}} <div class="float-end"><i class="ti ti-chevron-right"></i></div></a>
                                <a href="#payment-settings" class="list-group-item list-group-item-action">{{__('Payment')}} <div class="float-end"><i class="ti ti-chevron-right"></i></div></a>
                                <a href="#invoices-settings" class="list-group-item list-group-item-action">{{__('Invoices')}} <div class="float-end"><i class="ti ti-chevron-right"></i></div></a>
                                <a href="#zoom-settings" class="list-group-item list-group-item-action">{{__('Zoom Meeting')}} <div class="float-end"><i class="ti ti-chevron-right"></i></div></a>
                                 @if(Auth::user()->type == 'user')
                                <a href="#slack-setting" class="list-group-item list-group-item-action">{{__('Slack Setting ')}}<div class="float-end"><i class="ti ti-chevron-right"></i></div></a>
                                <a href="#telegram-setting" class="list-group-item list-group-item-action">{{__('Telegram Setting')}} <div class="float-end"><i class="ti ti-chevron-right"></i></div></a>
                                 @endif
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="table-responsive">
                                            ...
                                            <table id="selection-datatable" class="table table-bordered px-2">
                                                <thead>
                                                <tr>
                                                    <th>{{__('Name')}}</th>
                                                    <th>{{__('Rate')}}</th>
