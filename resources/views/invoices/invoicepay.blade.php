...
<div class="row text-center d-print-none">
                        <div class="col-sm-12 invoice-btn-group text-center mb-3">
                            <button type="button"
                                class="btn btn-print-invoice  btn-primary m-b-10 m-r-10 "> <a href="{{route('client.invoice.print',[$currentWorkspace->slug,\Illuminate\Support\Facades\Crypt::encryptString($invoice->id)])}}" class="text_white">
...
@section('content')
                 <div class="row">
                    <div class="card col-9" id="printTable">
                        <div class="card-body">
                            <div class="row ">
                                        ...
                                        <div class="col-sm-12">
                                                     ...
                                                     {{$currentWorkspace->address}},
                                                        ...
                                                        @endif 
                                                         ...
                                                         @if($currentWorkspace->zipcode) -{{$currentWorkspace->zipcode}},<br>
                                                       
                                                         @endif
                                                          @if($currentWorkspace->country)
                                                         {{$currentWorkspace->country}},<br>
                                                        @endif
                                                        @if($currentWorkspace->telephone) {{$currentWorkspace->telephone}}
                                                        @endif
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row invoive-info d-print-inline-flex">
                                ...
                                <div class="col-sm-4">
                                    <h6 class="m-b-20">Invoice Number:  <span>{{App\Models\Utility::invoiceNumberFormat($invoice->invoice_id)}}</span></h6>
                                    <h6 class="text-uppercase text-danger">{{__('Due Amount')}} :
                                        ...
                                        <table class="table table-responsive invoice-table ">
                                            <tbody>
                                                ...
                                                <tr>
                                                  ...
                                                  @if($invoice->tax)
                                                <tr>
                                                    <th>{{__('Tax')}} {{$invoice->tax->name}} ({{$invoice->tax->rate}}%)</th>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <hr />
                                                        <h5 class="text-primary">{{$currentWorkspace->priceFormat($invoice->getTotal())}}</h5>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
